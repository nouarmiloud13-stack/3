...
info "2/6 — Installation des dépendances système..."
...
# ── 3. Dossier projet ─────────────────────────────────────────────────────────
info "3/6 — Création structure projet..."
INSTALL_DIR="/opt/gnl"
mkdir -p "$INSTALL_DIR"
mkdir -p /var/log/gnl
...
info "4/6 — Installation des packages Python..."
...
# ── 5. Service systemd ────────────────────────────────────────────────────────
info "5/6 — Installation service systemd..."
...
# ── 6. Sécurité ───────────────────────────────────────────────────────────────
info "6/6 — Configuration sécurité..."
